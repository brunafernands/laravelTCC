...
<div class="container">
  <header class="blog-header py-3">
    <div class="row flex-nowrap justify-content-between align-items-center">
      ...
      <img style="width: 34px" src="{{url('/img/logo.jpg')}}" >
  ...
  <div class="nav-scroller py-1 mb-2">
    <nav class="nav d-flex justify-content-between">
      <a class="p-2 text-muted" href="{{ url('/sobreNos') }}">Sobre Nós</a>
      <a class="p-2 text-muted" href="{{ url('/artigos') }}">Artigos</a>
      <a class="p-2 text-muted" href="{{ url('/galeria') }}">Galeria</a>
      <a class="p-2 text-muted" href="{{ url('/produtos') }}">Produtos</a>
      <a class="p-2 text-muted" href="">Espaço do Cliente</a>
